...
class ResourceCalendar(models.Model):
    ...
    def att_get_work_intervals(self, day_start, day_end,tz,domain=None, resource=None):
        day_start = day_start.replace(tzinfo=tz)
        day_end = day_end.replace(tzinfo=tz)
        attendance_intervals = self._attendance_intervals_batch(day_start, day_end, domain=None)[False]
        working_intervals = []
